...
async def process_video():
    # Session String ကို သုံးပြီး Login Step ကို ကျော်မယ်
    # ဒါဆို FloodWait လုံးဝ မတက်တော့ဘူး
    app = Client(
        "worker",
        api_id=int(os.environ.get("API_ID")),
        api_hash=os.environ.get("API_HASH"),
        session_string=os.environ.get("SESSION_STRING") # Secret ထဲက String ကို သုံးမယ်
    )
